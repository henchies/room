...
THREE.CTMLoader.prototype.createModelBuffers = function ( file, callback ) {
	...
	var Model = function ( ) {
		...
		//console.log( "vertexIndexArray: " + vertexIndexArray.length );
		vertexPositionArray = file.body.vertices,
		//console.log( "vertexPositionArray: " + file.body.vertices.length );
		vertexNormalArray = file.body.normals;
    
		if ( file.body.indices !== undefined && file.body.indices.length > 0 ) {

				 console.log( "vertexIndexArray: " + file.body.indices.length );
		}
		
		if ( file.body.vertices !== undefined && file.body.vertices.length > 0 ) {

				 console.log( "vertexPositionArray: " + file.body.vertices.length );
		}
		
		if ( file.body.normals !== undefined && file.body.normals.length > 0 ) {

				 console.log( "vertexNormalArray: " + file.body.normals.length );
		}
		
		var vertexUvArray, vertexColorArray;
        console.log( "hej" + vertexUvArray );
        
		if ( file.body.uvMaps !== undefined && file.body.uvMaps.length > 0 ) {

			vertexUvArray = file.body.uvMaps[ 0 ].uv;
			 console.log( "vertexUvArray: " + vertexUvArray.length );
		}
